...
insert into project values (1, 'ALFA', 20000, STR_TO_DATE('2-JAN-2006', '%d-%b-%Y'), STR_TO_DATE('30-MAR-2006', '%d-%b-%Y'), STR_TO_DATE('7-APR-2006', '%d-%b-%Y'), 102);
insert into project values (2, 'BETA', 10000, STR_TO_DATE('5-MAY-2006', '%d-%b-%Y'), STR_TO_DATE('15-JUL-2006', '%d-%b-%Y'), STR_TO_DATE('15-JUL-2006', '%d-%b-%Y'), 103); 
insert into project values (3, 'GAMA', 10000, STR_TO_DATE('11-DEC-2006', '%d-%b-%Y'), STR_TO_DATE('15-JAN-2007', '%d-%b-%Y'), STR_TO_DATE('17-JAN-2007', '%d-%b-%Y'), 102); 

insert into works_on values(1, 125, STR_TO_DATE('1-FEB-2006', '%d-%b-%Y'), STR_TO_DATE('7-APR-2006', '%d-%b-%Y'));
insert into works_on values(1, 136, STR_TO_DATE('2-JAN-2006', '%d-%b-%Y'), STR_TO_DATE('30-MAR-2006', '%d-%b-%Y'));
insert into works_on values(1, 140, STR_TO_DATE('15-FEB-2006', '%d-%b-%Y'), STR_TO_DATE('7-APR-2006', '%d-%b-%Y'));
insert into works_on values(2, 145, STR_TO_DATE('6-MAY-2006', '%d-%b-%Y'), STR_TO_DATE('15-JUL-2006', '%d-%b-%Y'));
insert into works_on values(2, 125, STR_TO_DATE('6-MAY-2006', '%d-%b-%Y'), STR_TO_DATE('15-JUL-2006', '%d-%b-%Y'));
insert into works_on values(2, 101, STR_TO_DATE('6-MAY-2006', '%d-%b-%Y'), STR_TO_DATE('15-JUL-2006', '%d-%b-%Y'));
insert into works_on values(2, 148, STR_TO_DATE('14-MAY-2006', '%d-%b-%Y'), STR_TO_DATE('10-JUL-2006', '%d-%b-%Y'));
insert into works_on values(2, 200, STR_TO_DATE('6-MAY-2006', '%d-%b-%Y'), STR_TO_DATE('15-JUL-2006', '%d-%b-%Y'));
insert into works_on values(3, 145, STR_TO_DATE('15-DEC-2007', '%d-%b-%Y'), STR_TO_DATE('15-JAN-2007', '%d-%b-%Y'));
insert into works_on values(3, 148, STR_TO_DATE('14-DEC-2006', '%d-%b-%Y'), STR_TO_DATE('17-JAN-2007', '%d-%b-%Y'));
insert into works_on values(3, 150, STR_TO_DATE('14-DEC-2006', '%d-%b-%Y'), STR_TO_DATE('17-JAN-2007', '%d-%b-%Y'));
insert into works_on values(3, 162, STR_TO_DATE('20-DEC-2006', '%d-%b-%Y'), STR_TO_DATE('17-JAN-2007', '%d-%b-%Y'));
insert into works_on values(3, 101, STR_TO_DATE('20-DEC-2006', '%d-%b-%Y'), STR_TO_DATE('17-JAN-2007', '%d-%b-%Y'));
insert into works_on values(3, 176, STR_TO_DATE('20-DEC-2006', '%d-%b-%Y'), STR_TO_DATE('17-JAN-2007', '%d-%b-%Y'));
insert into works_on values(3, 200, STR_TO_DATE('20-DEC-2006', '%d-%b-%Y'), STR_TO_DATE('17-JAN-2007', '%d-%b-%Y'));
insert into works_on values(3, 140, STR_TO_DATE('15-DEC-2006', '%d-%b-%Y'), STR_TO_DATE('7-JAN-2007', '%d-%b-%Y'));
